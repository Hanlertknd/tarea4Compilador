...
public class FrmPrincipal extends javax.swing.JFrame {
        ...
        while (true) {
            ...
            switch (token) {
                ...
                case Comillas:
                    ...
                    break;
                case Print:
                    resultado += "  <Impresion en consola>\t" + lexer.lexeme + "\n";
                    break;
                case If:
                ...
                case Corchete_c:
                    ...
                    break;
                case P_coma:
                    resultado += "  <Agrupa Instruciones>\t" + lexer.lexeme + "\n";
                    break;
                case Identificador:
                ...
                case ERROR:
                    ...
                    break;
                case Conector:
                    resultado += "  <Valores en rango>\t" + lexer.lexeme + "\n";
                    break;
                case In:
    ...
    private void initComponents() {
        ...
        btnArchivo.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        btnArchivo.setText("Buscar");
        btnArchivo.setActionCommand("Examinar");
        ...
        btnAnalizarLex.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        btnAnalizarLex.setText("Analizador Lexico");
        btnAnalizarLex.setActionCommand(" Analizar");
        ...
        btnLimpiarLex.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        btnAnalizarSin.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        btnAnalizarSin.setText("Analizador Sintactico");
        btnAnalizarSin.setToolTipText("");
        ...
        btnLimpiarSin.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
    ...
    private void btnAnalizarSinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSinActionPerformed
        ...
        try {
            s.parse();
            txtAnalizarSin.setText("Análisis sintactico Exitoso");
